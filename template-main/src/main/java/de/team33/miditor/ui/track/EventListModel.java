        ...
        public void accept(UIController.SetTrack message) {
            ...
            if (EventListModel.this.m_Track != track) {
                if (EventListModel.this.m_Track != null) {
                    EventListModel.this.m_Track.getRegister(MidiTrack.SetEvents.class).remove(EventListModel.this.m_TrckClient);
                ...
                if (track == null) {
                    ...
                    EventListModel.this.m_Track.getRegister(MidiTrack.SetEvents.class).add(EventListModel.this.m_TrckClient);
                }
            }
